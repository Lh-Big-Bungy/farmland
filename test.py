...
def get_land_tree_fee(data, dijia):
    for i in data:
        if i[1] == "旱地":
            ...
            jiangqishuichi_alg(i, dijia)
        elif "土鱼塘" in i[1]:
            tuyutang_alg(i, dijia)
        else:
                    ...
                    if type in i[1]:
                        for daxiao, fee in value.items():
                            if daxiao in i[1]:
                                money = fee
                                print(i[1], money)
                                if key == ("椪柑", "春柑", "杂柑", "橙子", "木瓜"):
                                    tree_alg(i, dijia, money)
                                    return
                                if key == ("柑橘", "柚子", "脆蜜桃", "布朗李"):
                                    tree_alg(i, dijia, money)
                                    return
                                if key == ("葡萄", "猕猴桃"):
                                    tree_alg(i, dijia, money)
                                ...
                                if key == ("茶树", "保健类"):
                                    tree_alg(i, dijia, money)
                                    return
                                if key == ("李子", "杏子", "桃子", "梨子", "石榴", "枇杷", "樱桃", "林青", "苹果", "核桃", "板栗",
                                           "拐椒", "枣", "柿子", "油茶", "油桐", "杜仲", "黄柏", "厚朴", "吴萸", "丹皮", "辛夷",
                                           "当归", "栀果", "天麻", "黄姜", "重楼", "地乌", "八角", "花椒", "胡椒", "山胡椒", "香椿",
                                           "漆树", "桑树"):
                                    tree_alg(i, dijia, money)
                                    return
                                if key == "绿化树木":
